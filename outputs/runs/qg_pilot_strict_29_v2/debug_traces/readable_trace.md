...
**Generated:** 2026-05-02T20:57:35.708880
**Total items:** 29
...
**Grammar:** PASS
**Filter reason:** answer_consistency=no: extracted from text: asks=no ans=yes cons=no; path_coverage=covers 0 PRIOR events (all events EXCEPT the last one), need >= 1 [FAIL]
...
**Grammar:** PASS
**Filter reason:** path_coverage=covers 1 PRIOR events (all events EXCEPT the last one), need >= 2 [FAIL]
**Solver:** status=not_run result= correct=None confidence=0.0
...
**Grammar:** PASS
**Filter reason:** path_coverage=covers 0 PRIOR events (all events EXCEPT the last one), need >= 1 [FAIL]
**Solver:** status=not_run result= correct=None confidence=0.0
...
**Grammar:** PASS
**Filter reason:** path_coverage=covers 0 all events in the path, need >= 1 [FAIL]
**Solver:** status=not_run result= correct=None confidence=0.0
...
**Grammar:** PASS
**Filter reason:** all checks passed
**Solver:** status=ok result=The statue of of Madonna wore a bra. correct=0.0 confidence=0.0
...
**Grammar:** PASS
**Filter reason:** all checks passed
**Solver:** status=ok result=No coroner inquest was conducted. correct=1.0 confidence=0.0
...
**Grammar:** PASS
**Filter reason:** filter_exception: AttributeError: 'str' object has no attribute 'get'
**Solver:** status=not_run result= correct=None confidence=0.0
...
**Grammar:** PASS
**Filter reason:** all checks passed
**Solver:** status=ok result=฿8 billion correct=0.0 confidence=0.0
...
**Grammar:** PASS
**Filter reason:** answer_consistency=no: extracted from text: asks=no ans=yes cons=no; path_coverage=covers 1 PRIOR events (all events EXCEPT the last one), need >= 2 [FAIL]
**Solver:** status=not_run result= correct=None confidence=0.0
...
**Grammar:** PASS
**Filter reason:** path_coverage=covers 0 PRIOR events (all events EXCEPT the last one), need >= 2 [FAIL]
**Solver:** status=not_run result= correct=None confidence=0.0
...
**Grammar:** PASS
**Filter reason:** all checks passed
**Solver:** status=ok result=The demand for furs f the primary economic activity in Minnesota gradually declined during the 1 1 century as. correct=0.0 confidence=0.0
