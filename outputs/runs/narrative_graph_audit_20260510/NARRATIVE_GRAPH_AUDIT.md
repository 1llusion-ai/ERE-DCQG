...
| N3 | outcome | 31 | answer | the youth agreed to the bargain. | youth, old man |
...
| N3 | state | 6 | anchor | at length it was too much for his mother. | mother |
...
| Source | Target | Relation | Necessity | Reason |
|---|---|---|---|---|
| N1 | N3 | causes | strong | the worsening condition of the mother due to the p |
| N2 | N1 | causes | strong | the youth's growing need for food worsened the mot |
| N3 | N4 | motivates | partial | the mother's inability to cope led her to reconsid |
...
| N2 | N3 | causes | strong | The courtier's forced promise from the princess re |
...
| Source | Target | Relation | Necessity | Reason |
|---|---|---|---|---|
| N1 | N2 | temporal_before | strong | The king's departure is a direct consequence of th |
| N2 | N3 | causes | strong | The queen's harsh and unkind nature, revealed afte |
...
Most common node type: **action** (22)
Most common edge relation: **causes** (15)
