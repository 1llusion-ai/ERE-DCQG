...
description: "Autonomous multi-round research review loop. Repeatedly reviews using Codex via Codex-review MCP, implements fixes, and re-reviews until positive assessment or max rounds reached. Use when user says \"auto review loop\", \"review until it passes\", or wants autonomous iterative improvement."
---
