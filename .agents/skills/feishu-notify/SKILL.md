...
| **Interactive** | `"interactive"` | Full bidirectional. Approve/reject from Feishu, reply to checkpoints | [feishu-Codex](https://github.com/joewongjc/feishu-Codex) running |
...
Interactive mode uses [feishu-Codex](https://github.com/joewongjc/feishu-Codex) as a bridge:
