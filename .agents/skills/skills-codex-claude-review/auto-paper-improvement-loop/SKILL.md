...
description: "Autonomously improve a generated paper via Codex review through Codex-review MCP → implement fixes → recompile, for 2 rounds. Use when user says \"改论文\", \"improve paper\", \"论文润色循环\", \"auto improve\", or wants to iteratively polish a generated paper."
---
...
Send the full paper text to Codex review:
...
<details>
<summary>Codex review Review (Round 1)</summary>
...
<details>
<summary>Codex review Review (Round 2)</summary>
...
- **Save FULL raw review text** — do not summarize or truncate Codex reviewer responses
