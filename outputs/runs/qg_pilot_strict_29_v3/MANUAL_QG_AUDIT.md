...
- **generated_question:** How were the 100 victims who did not require hospitalization after the Myyrmanni bombing treated?
- **generation_error:** False
- **retry_attempts:** 3
- **grammar_pass:** True (pass)
- **answer_phrase_pass:** True (valid phrase)
- **weak_trigger_pass:** True (not a weak trigger)
- **answer_consistency:** judge_error (judge_error after 3 attempts: The pérdida_target":"released" yes"| by||"Yes| yes:" yes the scene?"
yes")
...
- **generated_question:** What event did Vice president Julio Cobos arrange after Raúl Alfonsín's death in 2009?
- **generation_error:** False
- **retry_attempts:** 2
- **grammar_pass:** True (pass)
- **answer_phrase_pass:** True (valid phrase)
...
- **solver_answer:** Three days of national mourning.
...
- **generated_question:** What did not happen despite the case becoming a cause célèbre?
- **generation_error:** False
- **retry_attempts:** 3
- **grammar_pass:** True (pass)
- **answer_phrase_pass:** True (valid phrase)
...
- **generated_question:** What did the cyclone produce in Thailand?
- **generation_error:** False
- **retry_attempts:** 2
- **grammar_pass:** True (pass)
- **answer_phrase_pass:** True (valid phrase)
...
- **final_filter_pass:** True
- **final_filter_reason:** all checks passed
- **solver_answer:** Significant storm surge, damage/loss.
- **solver_eval_status:** ok
- **judge_answerable:** 1.0
...
- **generated_question:** What did Brant do in response to the atrocities at Cherry Valley?
- **generation_error:** False
- **retry_attempts:** 3
- **grammar_pass:** True (pass)
- **answer_phrase_pass:** True (valid phrase)
...
- **generated_question:** What did the members of the Irgun do in the basement of the hotel's main building to carry out the attack on British authorities? ?
- **generation_error:** False
- **retry_attempts:** 3
...
- **generated_question:** What economic resource became key in Minnesota during the 19th century after fur trade declined?
- **generation_error:** False
- **retry_attempts:** 3
- **grammar_pass:** True (pass)
- **answer_phrase_pass:** True (valid phrase)
...
- **generated_question:** What event followed the heavier casualties suffered by the Portuguese fleet and led to the forces of the Sultanate of Johor joining the Dutch in their campaign against the Portuguese?
- **generation_error:** False
- **retry_attempts:** 3
- **grammar_pass:** True (pass)
- **answer_phrase_pass:** True (valid phrase)
...
- **final_filter_pass:** True
- **final_filter_reason:** all checks passed
- **solver_answer:** Battle rallied forces.
- **solver_eval_status:** ok
- **judge_answerable:** 1.0
- **judge_solver_correct:** 0.0
- **judge_support_covered:** 1.0
...
- **generated_question:** How did Marlene Stewart contribute to the costumes for the Who's That Girl Tour, and what was the impact of these costumes on the show?
- **generation_error:** False
- **retry_attempts:** 3
- **grammar_pass:** True (pass)
- **answer_phrase_pass:** True (valid phrase)
...
- **final_filter_pass:** False
- **final_filter_reason:** answer_consistency=no: extracted from text: asks=no ans=yes cons=no; path_coverage=covers 0 prior events, need >= 1 [FAIL]
- **solver_answer:** not_run
- **solver_eval_status:** not_run
- **judge_answerable:** True
- **judge_solver_correct:** ?
...
- **generated_question:** What did the NATO operation's engagement in bombing ground targets near Goražde in April 1994 help to demonstrate?
- **generation_error:** False
- **retry_attempts:** 3
- **grammar_pass:** True (pass)
- **answer_phrase_pass:** True (valid phrase)
...
- **final_filter_pass:** True
- **final_filter_reason:** all checks passed
- **solver_answer:** NATO's adaptability post-Cold War.
- **solver_eval_status:** ok
- **judge_answerable:** 1.0
- **judge_solver_correct:** 0.0
- **judge_support_covered:** 1.0
...
- **generated_question:** What provided a morale-lifting consolation to the Chinese people following the Japanese invasion of Shanghai?
- **generation_error:** False
- **retry_attempts:** 1
- **grammar_pass:** True (pass)
- **answer_phrase_pass:** True (valid phrase)
- **weak_trigger_pass:** True (not a weak trigger)
- **answer_consistency:** judge_error (judge_error after 3 attempts: {"asks_target":"yes","answer":"yes","consistent":"yes","s":"brief"})
- **path_coverage:** count=1 pass=True (covers 1 prior events, need >= 1 [PASS])
- **final_filter_pass:** True
- **final_filter_reason:** all checks passed
- **solver_answer:** The successful defense of Sihang Warehouse.
- **solver_eval_status:** ok
- **judge_answerable:** 1.0
- **judge_solver_correct:** 0.0
- **judge_support_covered:** 1.0
...
- **answer_consistency:** judge_error (judge_error after 3 attempts: {"{"The offensive did the Kurdish forces do on the December 1 24 conduct an offe)
- **path_coverage:** count=1 pass=True (covers 1 prior events, need >= 1 [PASS])
- **final_filter_pass:** True
- **final_filter_reason:** all checks passed
...
- **final_filter_pass:** True
- **final_filter_reason:** all checks passed
- **solver_answer:** NATO bombing took two UN UN peacekeepers in hostages.
- **solver_eval_status:** ok
- **judge_answerable:** 1.0
- **judge_solver_correct:** 0.0
- **judge_support_covered:** 1.0
...
- **generated_question:** What did the Crimean War prove to be for Nikolaevan Russia's educated elites? 
- **generation_error:** False
- **retry_attempts:** 3
- **grammar_pass:** True (pass)
- **answer_phrase_pass:** True (valid phrase)
...
- **final_filter_pass:** True
- **final_filter_reason:** all checks passed
- **solver_answer:** Ordered a charge.
- **solver_eval_status:** ok
- **judge_answerable:** 1.0
- **judge_solver_correct:** 1.0
- **judge_support_covered:** 1.0
...
- **generated_question:** When did the warnings and the hotel manager notification occur before occur before the bombing occurred take take place?
- **generation_error:** False
- **retry_attempts:** 2
- **grammar_pass:** False (base: word repetition: take)
- **answer_phrase_pass:** True (valid phrase)
- **weak_trigger_pass:** True (not a weak trigger)
- **answer_consistency:** no (skipped (early exit))
- **path_coverage:** count=0 pass=False (skipped (early exit))
- **shortcut_without_path:** N/A
- **needs_prior_events:** N/A
- **hard_degraded:** False (not checked)
- **final_filter_pass:** False
- **final_filter_reason:** grammar=base: word repetition: take; answer_consistency=no: skipped (early exit); path_coverage=skipped (early exit)
- **solver_answer:** not_run
- **solver_eval_status:** not_run
- **judge_answerable:** None
- **judge_solver_correct:** ?
...
- **generated_question:** After the shopping center was especially crowded with many children present and the bombing took place, how was the investigation concluded?
- **generation_error:** False
- **retry_attempts:** 1
- **grammar_pass:** True (pass)
- **answer_phrase_pass:** True (valid phrase)
...
- **answer_phrase_pass:** True (valid phrase)
- **weak_trigger_pass:** True (not a weak trigger)
- **answer_consistency:** judge_error (judge_error after 3 attempts: {"asks_target":"yes","answer":"yes","consistent":"yes","reason "The answer is co)
- **path_coverage:** count=3 pass=True (covers 3 prior events, need >= 2 [PASS])
- **shortcut_without_path:** no
- **needs_prior_events:** yes
- **hard_degraded:** False (not degraded: shortcut=no, needs_prior=yes)
...
- **generated_question:** What event followed the western-most Allied corps surrounding and isolating Bayonne and the remaining two Allied corps pushing Soult's army back to Orthez?
- **generation_error:** False
- **retry_attempts:** 2
- **grammar_pass:** True (pass)
- **answer_phrase_pass:** True (valid phrase)
...
- **final_filter_pass:** True
- **final_filter_reason:** all checks passed
- **solver_answer:** The Portuguese agreed this by by agreeingis tois by
- **solver_eval_status:** ok
- **judge_answerable:** 1.0
- **judge_solver_correct:** 0.0
- **judge_support_covered:** 1.0
...
- **gold_answer_sentence:** These engagements helped show that NATO had adapted to the post-Cold War era and could operate in environments other than a major force on force engag
- **generated_question:** After Operation Deny Flight began and provided close air support for UN troops, how did NATO's actions during the mission help demonstrate its adaptation to the post-Cold War era?
- **generation_error:** False
- **retry_attempts:** 2
- **grammar_pass:** True (pass)
- **answer_phrase_pass:** True (valid phrase)
- **weak_trigger_pass:** True (not a weak trigger)
- **answer_consistency:** judge_error (judge_error after 3 attempts: {"asks_target":"yes","answer":"yes","consistent":"yes","reason":"brief"})
- **path_coverage:** count=3 pass=True (covers 3 prior events, need >= 2 [PASS])
- **shortcut_without_path:** no
- **needs_prior_events:** yes
- **hard_degraded:** False (not degraded: shortcut=no, needs_prior=yes)
...
- **hard_degraded:** False (not degraded: shortcut=no, needs_prior=yes)
- **final_filter_pass:** False
- **final_filter_reason:** answer_consistency=no: extracted from text: asks=no ans=yes cons=no
- **solver_answer:** not_run
- **solver_eval_status:** not_run
- **judge_answerable:** True
- **judge_solver_correct:** ?
