...
**Citation rules** (from Codex-scholar + Imbad0202/academic-research-skills):
...
Send the complete outline to Codex review for feedback:
...
Outline methodology inspired by [Research-Paper-Writing-Skills](https://github.com/Master-cai/Research-Paper-Writing-Skills) (claim-evidence mapping), [Codex-scholar](https://github.com/Galaxy-Dawn/Codex-scholar) (citation verification), and [Imbad0202/academic-research-skills](https://github.com/Imbad0202/academic-research-skills) (claim verification protocol).
