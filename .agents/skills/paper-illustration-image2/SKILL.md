...
description: "Generate publication-quality academic illustrations through a local Codex app-server bridge that uses Codex native image generation. This is a separate experimental alternative to `paper-illustration`, intended for Codex users who want a GPT-image-style renderer without modifying the original skill."
...
│          ▼                                                               │
│   ┌─────────────┐                                                        │
│   │Codex/Codex │ ◄─── Step 2: Optimize layout description               │
...
│          ▼                                                               │
│   ┌─────────────┐                                                        │
│   │Codex/Codex │ ◄─── Step 3: CVPR/NeurIPS style verification           │
...
| Step 2 | Codex (+ optional Codex critique) | Refine layout, grouping, spacing, and arrow routing |
| Step 3 | Codex (+ optional Codex critique) | Verify academic visual style before rendering |
